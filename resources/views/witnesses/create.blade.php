                ...
                <div class="panel-body">
                    ...
                    <form action="{{ route('witnesses.store') }}" method="POST" enctype="multipart/form-data">
                       ...
                       <div class="form-group d-flex justify-content-between align-items-center mt-3">
                          ...
                          <!-- Go to /witnesses Button (Middle) -->
                          <a href="/witnesses" class="btn btn-info d-inline-flex align-items-center gap-2">
                            <i class="fa fa-users"></i> <span>View Witnesses</span>
                          </a>

                          <!-- Submit Witness Button (Right) -->
                          <button type="submit" class="btn btn-primary d-inline-flex align-items-center gap-2">
                            <i class="fa fa-paper-plane"></i> <span>Submit Witness</span>
                          </button>
                        </div>
