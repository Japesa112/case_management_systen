        ...
        <div class="col-md-12 mt-4">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    <h4 class="panel-title">AG Advice Form</h4>
                ...
                <div class="panel-body">
                    ...
                    <form action="{{ route('ag_advice.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <textarea name="ag_advice" id="ag_advice" class="form-control" rows="2" placeholder="Enter advice details" required></textarea>
                                </div>
    ...
    <script>
        swal({
            ...
            if (willUpload) {
                ...
                window.location.href = "{{ route('ag_advice.index') }}?message=Adjourn+added+successfully";
            }
        });
    </script>
@endif
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addDocumentModalLabel">Add Advice Document  </h5>
