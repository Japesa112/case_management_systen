                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" style="color: rgb(1, 9, 12)" id="addEvaluationModalLabel">Create Payment</h5>
                        ...
                        <form id="editPaymentForm" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <textarea name="auctioneer_involvement" id="edit_auctioneer_involvement" class="form-control" rows="2"></textarea>
                                </div>
...
<script>
    $(document).ready(function () {
        $(document).on('click', '.view-payment', function () {
            ...
            $.ajax({
                url: "{{ route('all_payments.show', ':id') }}".replace(':id', paymentId),
                type: "GET",
                ...
                success: function (response) {
                    if (response.exists) {
                        if (response.evaluation) {
                            ...
                            window.location.href = "{{ route('all_payments.create', ':case_id') }}"
