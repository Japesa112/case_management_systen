...
CREATE TABLE IF NOT EXISTS `notification_preferences` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `notification_preferences_ibfk_1` (`user_id`)
...
(3, 'jamesowino444', 'omulodeveloper@gmail.com', '$2y$12$WAzExmBHtYstMoJ80YzSKO2MmMHqJkuW7v49nxkqzo3vpFUAg2waC', 'James Owino', '0702111444', 'Admin', 'Pending', '2025-03-17 08:18:30', '2025-03-17 08:18:30', '103535761912352333445', '2025-06-24 04:11:45', '2025-06-23 09:23:29', NULL),
(16, 'kevinwaweru760', 'intern-ict@ku.ac.ke', '$2y$12$ioTyRNmW4W5KXEXA5iChLew6.uvaA4h1nOG45LhNamQho.dqhSwUK', 'Kevin Waweru', '0746282760', 'Lawyer', 'Pending', '2025-06-20 07:46:50', '2025-06-20 07:46:50', NULL, '2025-06-23 06:34:33', '2025-06-23 06:35:17', NULL),
(21, 'jamesomolo763', 'isaiah132@gmail.com', '$2y$12$EJDM3.uRf3hhhCzJnrt/HuUMLQRXhYsyxEII3sxgKz2./8IVLIG/e', 'James Omolo', '0746282763', 'Lawyer', 'Pending', '2025-06-23 06:08:24', '2025-06-23 06:08:24', NULL, NULL, NULL, NULL),
(22, 'jacktonemariadho762', 'mariadho@gmail.com', '$2y$12$l/X9FfgvPvvjNtlsTCXAROrl1zmYEhkCT7GZIf7B7Zn579fKRJJhq', 'Jacktone Mariadho', '0746282762', 'DVC', 'Pending', '2025-06-23 12:05:00', '2025-06-23 12:05:00', NULL, '2025-06-23 09:23:49', '2025-06-23 09:21:15', NULL);
...
ALTER TABLE `adjourns`
  ADD CONSTRAINT `adjourns_ibfk_1` FOREIGN KEY (`case_id`) REFERENCES `cases` (`case_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `adjourn_attachments`
--
ALTER TABLE `adjourn_attachments`
  ADD CONSTRAINT `adjourn_attachments_ibfk_1` FOREIGN KEY (`adjourns_id`) REFERENCES `adjourns` (`adjourns_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `appeal`
--
ALTER TABLE `appeal`
  ADD CONSTRAINT `appeal_ibfk_1` FOREIGN KEY (`case_id`) REFERENCES `cases` (`case_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `appeal_attachments`
--
ALTER TABLE `appeal_attachments`
  ADD CONSTRAINT `fk_appeal_attachments_appeal` FOREIGN KEY (`appeal_id`) REFERENCES `appeal` (`appeal_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `caseclosures`
--
ALTER TABLE `caseclosures`
  ADD CONSTRAINT `caseclosures_ibfk_1` FOREIGN KEY (`case_id`) REFERENCES `cases` (`case_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `caseclosure_attachments`
--
ALTER TABLE `caseclosure_attachments`
  ADD CONSTRAINT `fk_caseclosure_attachments` FOREIGN KEY (`caseclosure_id`) REFERENCES `caseclosures` (`closure_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `cases`
--
ALTER TABLE `cases`
  ADD CONSTRAINT `cases_ibfk_1` FOREIGN KEY (`created_by`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `case_activities`
--
ALTER TABLE `case_activities`
  ADD CONSTRAINT `fk_case_activities_case` FOREIGN KEY (`case_id`) REFERENCES `cases` (`case_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `case_documents`
--
ALTER TABLE `case_documents`
  ADD CONSTRAINT `case_documents_ibfk_1` FOREIGN KEY (`case_id`) REFERENCES `cases` (`case_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `complainants`
  ADD CONSTRAINT `complainants_ibfk_1` FOREIGN KEY (`case_id`) REFERENCES `cases` (`case_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `documents_filing`
--
ALTER TABLE `documents_filing`
  ADD CONSTRAINT `documents_filing_ibfk_1` FOREIGN KEY (`case_id`) REFERENCES `cases` (`case_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `dvc_appointment`
--
ALTER TABLE `dvc_appointment`
  ADD CONSTRAINT `fk_dvc_appointment_forwarding` FOREIGN KEY (`forwarding_id`) REFERENCES `forwardings` (`forwarding_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_evaluation` FOREIGN KEY (`evaluation_id`) REFERENCES `evaluations` (`evaluation_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `dvc_appointment_attachment`
--
ALTER TABLE `dvc_appointment_attachment`
  ADD CONSTRAINT `fk_dvc_appointment` FOREIGN KEY (`appointment_id`) REFERENCES `dvc_appointment` (`appointment_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `evaluations`
--
ALTER TABLE `evaluations`
  ADD CONSTRAINT `evaluations_ibfk_1` FOREIGN KEY (`case_id`) REFERENCES `cases` (`case_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `evaluations_ibfk_2` FOREIGN KEY (`lawyer_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `evaluation_ag_advice`
--
ALTER TABLE `evaluation_ag_advice`
  ADD CONSTRAINT `case_ag_fk` FOREIGN KEY (`case_id`) REFERENCES `cases` (`case_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `evaluation_ag_advice_ibfk_1` FOREIGN KEY (`evaluation_id`) REFERENCES `evaluations` (`evaluation_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `forwardings`
--
ALTER TABLE `forwardings`
  ADD CONSTRAINT `evaluation_id_fk1` FOREIGN KEY (`evaluation_id`) REFERENCES `evaluations` (`evaluation_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `forwardings_ibfk_1` FOREIGN KEY (`case_id`) REFERENCES `cases` (`case_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `lawyers`
--
ALTER TABLE `lawyers`
  ADD CONSTRAINT `lawyers_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `lawyer_payments`
--
ALTER TABLE `lawyer_payments`
  ADD CONSTRAINT `lawyer_payments_ibfk_1` FOREIGN KEY (`lawyer_id`) REFERENCES `lawyers` (`lawyer_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `lawyer_payments_ibfk_2` FOREIGN KEY (`case_id`) REFERENCES `cases` (`case_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `lawyer_payment_attachments`
--
ALTER TABLE `lawyer_payment_attachments`
  ADD CONSTRAINT `fk_lawyer_payment_attachments` FOREIGN KEY (`lawyer_payment_id`) REFERENCES `lawyer_payments` (`payment_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `negotiations`
--
ALTER TABLE `negotiations`
  ADD CONSTRAINT `negotiations_ibfk_1` FOREIGN KEY (`case_id`) REFERENCES `cases` (`case_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `payments`
  ADD CONSTRAINT `payments_ibfk_1` FOREIGN KEY (`case_id`) REFERENCES `cases` (`case_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `payment_attachments`
--
ALTER TABLE `payment_attachments`
  ADD CONSTRAINT `fk_payment_attachments` FOREIGN KEY (`payment_id`) REFERENCES `payments` (`payment_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `pre_trials`
--
ALTER TABLE `pre_trials`
  ADD CONSTRAINT `pre_trials_ibfk_1` FOREIGN KEY (`case_id`) REFERENCES `cases` (`case_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `pre_trial_attachments`
--
ALTER TABLE `pre_trial_attachments`
  ADD CONSTRAINT `pre_trial_attachments_ibfk_1` FOREIGN KEY (`pretrial_id`) REFERENCES `pre_trials` (`pretrial_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `pre_trial_members`
--
ALTER TABLE `pre_trial_members`
  ADD CONSTRAINT `pre_trial_members_ibfk_1` FOREIGN KEY (`pretrial_id`) REFERENCES `pre_trials` (`pretrial_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `trials`
  ADD CONSTRAINT `trials_ibfk_1` FOREIGN KEY (`case_id`) REFERENCES `cases` (`case_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `trials_attachments`
--
ALTER TABLE `trials_attachments`
  ADD CONSTRAINT `trials_attachments_ibfk_1` FOREIGN KEY (`trial_id`) REFERENCES `trials` (`trial_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `trial_preparations`
--
ALTER TABLE `trial_preparations`
  ADD CONSTRAINT `trial_preparations_ibfk_2` FOREIGN KEY (`case_id`) REFERENCES `cases` (`case_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `trial_preparation_attachments`
--
ALTER TABLE `trial_preparation_attachments`
  ADD CONSTRAINT `trial_preparation_attachments_ibfk_1` FOREIGN KEY (`preparation_id`) REFERENCES `trial_preparations` (`preparation_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `trial_preparation_lawyer`
--
ALTER TABLE `trial_preparation_lawyer`
  ADD CONSTRAINT `fk_trial_preparation_lawyer_lawyer` FOREIGN KEY (`lawyer_id`) REFERENCES `lawyers` (`lawyer_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_trial_preparation_lawyer_preparation` FOREIGN KEY (`preparation_id`) REFERENCES `trial_preparations` (`preparation_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `trial_preparation_witness`
--
ALTER TABLE `trial_preparation_witness`
  ADD CONSTRAINT `fk_trial_preparation_witness_preparation` FOREIGN KEY (`preparation_id`) REFERENCES `trial_preparations` (`preparation_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_trial_preparation_witness_witness` FOREIGN KEY (`witness_id`) REFERENCES `witnesses` (`witness_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `user_notification`
--
ALTER TABLE `user_notification`
  ADD CONSTRAINT `fk_user_notification_notification` FOREIGN KEY (`notification_id`) REFERENCES `notifications` (`notification_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_user_notification_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;
