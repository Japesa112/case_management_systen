...
var handleDashboardGritterNotification = function(userName) {
	setTimeout(function() {
        ...
        if (currentHour >= 5 && currentHour < 12) {
            ...
            message = "Rise and shine! Wishing you a productive and positive start to your day.";
        } else if (currentHour >= 12 && currentHour < 18) {
            greeting = "Good afternoon";
            message = "Hope your day is going great! Keep up the amazing work.";
        } else if (currentHour >= 18 && currentHour < 21) {
            greeting = "Good evening";
            message = "Time to unwind and relax. Enjoy your evening!";
        } else {
            greeting = "Good night";
            message = "Hope you had a great day. Rest well and recharge for tomorrow!";
        }

        $.gritter.add({
            title: greeting + ', ' + userName + "!",
            text: message,
            image: '../images/ku_icon.png',
            sticky: true,
            time: '',
...
var DashboardV2 = function () {
	...
	return {
		...
		init: function (userName) {
			...
			handleDashboardGritterNotification(userName);
		}
	};
}();
/*
